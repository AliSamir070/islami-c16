  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration:const BoxDecoration(
        image: DecorationImage(image: AssetImage(AssetsManager.quranBack),
            fit: BoxFit.fill),
      ),
      child: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
             ...
             const SizedBox(height: 20,),
              const Text(StringsManager.mostRecently,style: TextStyle(
                color: ColorManager.textfieldColor,
                fontSize: 16,
                fontWeight: FontWeight.w700
              ),),
             const SizedBox(height: 10,),
              SizedBox(
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) =>const RecentlyItem(),
                    separatorBuilder: (context, index) => const SizedBox(width: 10,),
                    itemCount: 10),
              ),
              const SizedBox(height: 10,),
              const Text(StringsManager.surasList,style: TextStyle(
                  color: ColorManager.textfieldColor,
                  fontSize: 16,
                  fontWeight: FontWeight.w700
              ),),
